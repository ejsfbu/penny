...
public class ParseApp extends Application {
    ...
    public void onCreate() {
        ...
        final Parse.Configuration configurationUser
        ...
        final Parse.Configuration configurationGoal
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
        ...
        final Parse.Configuration configurationReward
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
        ...
        final Parse.Configuration configurationBank
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
        ...
        final Parse.Configuration configurationTransaction
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
        ...
        final Parse.Configuration configurationRequest
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
        ...
        final Parse.Configuration configurationAllowance
                = new Parse.Configuration.Builder(this)
                .applicationId("ejsfbu-money")
                .clientKey(getResources().getString(R.string.master_key))
                .server("https://youth-financial-planning.herokuapp.com/parse")
